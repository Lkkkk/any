...
public class GestureLoginActivity extends AppCompatActivity {
  ...
  @BindView(R.id.forgetGestureBtn) Button forgetGestureBtn;
  ...
  private void init() {
    ...
    //得到当前用户的手势密码
    gesturePassword = aCache.getAsBinary("GesturePassword");
   ...
   * 忘记手势密码（去账号登录界面）
   */
  @OnClick(R.id.forgetGestureBtn) void forgetGesturePasswrod() {
  ...
  private enum Status {
    //默认的状态
    DEFAULT(R.string.gesture_default, R.color.grey_a5a5a5), //密码输入错误
    ERROR(R.string.gesture_error, R.color.red_f4333c), //密码输入正确
